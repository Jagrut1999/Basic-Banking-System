...
<body>
    ...
    <table class="flat-table-1">
		...
		<tr>
			...
			<td>
				<form action="user.php" method="post"  class="view">
					<button class="button1" type="submit" name="name" value="Jd">View</button>
				</form>
			</td>
		</tr>
		<tr>
        ...
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1" type="submit" name="name" value="Nitish">View</button>
				</form>
			</td>
        ...
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1" type="submit" name="name" value="Bharat">View</button>
				</form>
			</td>
		</tr>
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1" type="submit" name="name" value="Bhargav">View</button>
				</form>
			</td>
        </tr>
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1"type="submit" name="name" value="Suraj">View</button>
				</form>
			</td>
		</tr>
        <tr>
        ...
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1"type="submit" name="name" value="Ruhi">View</button>
				</form>
			</td>
		</tr>
		</tbody>
